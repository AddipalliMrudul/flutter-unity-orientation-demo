...
{
    internal class XG_StandardShaderGUI : ShaderGUI
    {
        ...
        // XG Specific
        MaterialProperty ringUV = null;
        MaterialProperty ringColor = null;
        MaterialProperty ringRadius = null;
        MaterialProperty ringWidth = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            // XG Specific
            ringUV = FindProperty("_UV", props);
            ringColor = FindProperty("_RingColor", props);
            ringRadius = FindProperty("_RingRadius", props);
            ringWidth = FindProperty("_RingWidth", props);
        }
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                GUILayout.Label("XG Ring Properties", EditorStyles.boldLabel);
                DoXGRingArea(material);
                EditorGUILayout.Space();
        ...
        void DoXGRingArea(Material material)
        {
            m_MaterialEditor.VectorProperty(ringUV, "Ring UV");
            m_MaterialEditor.ColorProperty(ringColor, "Ring Color");
            m_MaterialEditor.FloatProperty(ringRadius, "Ring Radius");
            m_MaterialEditor.FloatProperty(ringWidth, "Ring Width");
        }
