...
namespace NotificationSamples
{
    ...
    /// </summary>
    public class GameNotificationsManager : BaseBehaviour
    {
        ...
        public event Action<string> LocalNotificationDeliveredMeta;
        ...
        /// <summary>
        /// Respond to application background event on quit.
        /// </summary>
        ...
        public void Initialize(Action<string> onNotificationClick, params GameNotificationChannel[] channels)
        {
            if (Initialized)
            {
...
#if UNITY_ANDROID && USE_LOCAL_NOTIFICATIONS
...
#elif UNITY_IOS && USE_LOCAL_NOTIFICATIONS
            ...
            GetLastNotificationIntent(onNotificationClick);
            OnForegrounding();
        }

        private void GetLastNotificationIntent(Action<string> onNotificationClick)
        {
            ...
            if (notificationIntentData != null)
            {
                ...
                onNotificationClick?.Invoke(notification.IntentData);
            }
        }
        ...
        private void OnNotificationReceived(IGameNotification deliveredNotification)
        {
            ...
            if (deliveredIndex >= 0)
            {
                ...
                LocalNotificationDeliveredMeta?.Invoke(deliveredNotification.Data);
