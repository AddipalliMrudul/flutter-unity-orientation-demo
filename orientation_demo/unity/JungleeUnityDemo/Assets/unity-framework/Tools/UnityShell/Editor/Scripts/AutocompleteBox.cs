...
namespace XcelerateGames.EditorTools
{
    ...
    public class AutocompleteBox
    {
        ...
        [SerializeField] public string[] results = new string[0];
        [SerializeField] private Vector2 scrollPos;
        private string searchString;
        [SerializeField] private int selectedIndex = -1;
        private bool showResults;
        [SerializeField] private int visualIndex = -1;
        #endregion//============================================================[ Data ]
        ...
        private void DrawResults(Rect drawRect)
        {
            ...
            GUI.BeginClip(clipRect);
            {
                ...
                if (results.Length > maxResults)
                {
                    ...
                    if (-elementRect.y > maxPos) elementRect.y = -maxPos;
                }
                ...
                if (results.Length > maxResults) DrawScroll(clipRect);
            }
            GUI.EndClip();
        }
        ...
        {
            var resultsShown = results.Length;
        ...
        private void UpdateVisualIndex(Rect clipRect)
        {
            ...
            else if (diffMin > 0) visualIndex -= Mathf.CeilToInt(diffMin / Styles.resultHeight);
        }
