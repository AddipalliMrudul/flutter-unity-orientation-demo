...
namespace XcelerateGames.EditorTools
{
    public class ResourceAnalyzer : EditorWindow
    {
        ...
        #region Data
        //Private
        private string[] inspectToolbarStrings = { "Textures", "Materials", "Meshes" };
        private string[] inspectToolbarStrings2 = { "Textures", "Materials", "Meshes", "Missing" };
        ...
        private bool IncludeLightmapTextures = true;
        ...
        void OnGUI()
        {
            ...
            if (GUILayout.Button("Calculate", GUILayout.Width(80), GUILayout.Height(30)))
                CheckResources();
            if (GUILayout.Button("CleanUp", GUILayout.Width(80), GUILayout.Height(30)))
        ...
        #region Public
        [MenuItem("XcelerateGames/EditorTools/ResourceAnalyzer %&#_r", false)]
        static void Init()
        {
            ResourceAnalyzer window = (ResourceAnalyzer)EditorWindow.GetWindow(typeof(ResourceAnalyzer), false, "Resource Analyzer");
